        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Food Delivery</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Electronics Repair</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">AC Services</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Technician Services</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Daily Needs</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Home Cleaning</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Book a Service</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Confirm Professional</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Enjoy the Service</h3>
              <p className="text-gray-600">
